...
import _JuspaySDKReact, { HyperFragmentView } from '_juspay-payments-sdk-react';
      ...
      <View style={styles.containerNew}>
        ...
        <CustomButton2
          ...
          onPress={() => {
            ...
            _JuspaySDKReact.process(JSON.stringify(payload));
          }}
        />
      </View>
    );
              ...
              <View>
                ...
                <CustomButton
                  ...
                  onPress={() => {
                    ...
                    _JuspaySDKReact.processWithActivity(JSON.stringify(payload));
                  }}
                /> */}
          ...
          {/* <View style={styles.containerSon2}>
            <CustomButton3
              ...
              onPress={() => {
                ...
                _JuspaySDKReact.process(JSON.stringify(data));
              }}
            />
          </View> */}
        </View>

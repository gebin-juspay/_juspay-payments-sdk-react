...
```sh
npm install _juspay-payments-sdk-react
```
...
```ts
import _JuspaySDKReact from '_juspay-payments-sdk-react';
```
...
_juspay-payments-sdk-react is distributed under [AGPL-3.0-only](https://github.com/juspay/_juspay-payments-sdk-react/src/main/LICENSE.md) license.
